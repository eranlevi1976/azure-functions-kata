...
public class QueueTrigger2 {
    ...
    public void run(
            @QueueTrigger(name = "message", queueName = "kata-rolling-queue-2", connection = "storageConnectionString") String messageIn,
            @QueueOutput(name = "message2", queueName = "kata-rolling-queue-3", connection = "storageConnectionString") OutputBinding<String> messageOut,
