...
public class QueueTrigger3 {
    ...
    public void run(
            @QueueTrigger(name = "message", queueName = "kata-rolling-queue-3", connection = "storageConnectionString") String messageIn,
            @QueueOutput(name = "message2", queueName = "kata-rolling-queue-1", connection = "storageConnectionString") OutputBinding<String> messageOut,
